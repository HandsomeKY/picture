...
public class MainJFrame extends JFrame {
	...
	public MainJFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Codes\\Java\\Java-Store-Management-System\\\u5546\u57CE.png"));
		setAlwaysOnTop(true);
		setTitle("\u8D85\u5E02\u552E\u5356\u7BA1\u7406\u7CFB\u7EDF");
		...
		JLabel lb_bianhao = new JLabel("\u8BA2\u5355\u7F16\u53F7");
		pane2_1_1.add(lb_bianhao);
		...
		JButton btn_bianhao = new JButton("\u67E5\u770B\u8BA2\u5355");
		pane2_1_2.add(btn_bianhao);
